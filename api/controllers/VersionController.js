...
module.exports = {
  ...
  availability: function (req, res) {
    ...
    var availability = new Date(parseInt(timestamp, 10));
    ...
    Version.findOne(version)
      .then(function (foundVersion) {
        ...
        return Version.update(version, { availability }).then(function (
          payload
        ) {
          var updatedVersion = payload[0];
    ...
    Version.find()
      .then(function (versions) {
        ...
        return Promise.all([
          ...
          // load flavors
          new Promise(function (resolve, reject) {
            return Promise.map(items, function (version) {
              return Flavor.findOne(version.flavor);
            })
              .then(resolve)
              .catch(reject);
          }),
  ...
  general: function (req, res) {
    ...
    var flavor = req.params.flavor || "default";
          ...
          .then(function (newerVersions) {
            ...
            var releaseNotes = _.reduce(
              ...
              function (prevNotes, newVersion) {
                newVersion.assets = _.filter(newVersion.assets, function (
                  asset
                ) {
      ...
      .then(function (currentVersion) {
        ...
        return Version.find(
          ...
          .then(function (newerVersions) {
            ...
            var assets = _.map(latestVersion.assets, function (asset) {
